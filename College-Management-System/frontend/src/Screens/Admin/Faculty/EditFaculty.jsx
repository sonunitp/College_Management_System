...
const EditFaculty = () => {
  ...
  const updateFacultyProfile = (e) => {
    ...
    data.subjects.forEach((subject) => {
      formData.append("subjects", subject._id); 
    });
    axios
    ...
    <div className="my-6 mx-auto w-full">
      ...
      {search && id && (
        ...
        >
          ...
          <div className="w-[40%]">
          <label className="leading-7 text-sm">Selected Subjects</label>
          <div className="px-2 bg-blue-50 py-3 rounded-sm text-base w-full mt-1">
            {data.subjects.length > 0 ? (
              data.subjects.map((subject) => (
                <div key={subject._id || subject} className="text-gray-700">
